...
import com.custom.core.xutils.db.annotation.Id;
import com.custom.core.xutils.db.annotation.Table;
...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.custom.core.xutils.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.custom.core.xutils.db.table.Id>();

    /* package */
    static synchronized com.custom.core.xutils.db.table.Id getId(Class<?> entityType) {
        ...
        com.custom.core.xutils.db.table.Id id = new com.custom.core.xutils.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.custom.core.xutils.db.table.Id id = getId(entityType);
