...
package com.custom.core.xutils.db.table;
...
import com.custom.core.xutils.LogUtils;
import com.custom.core.xutils.db.annotation.Check;
import com.custom.core.xutils.db.annotation.NotNull;
import com.custom.core.xutils.db.annotation.Transient;
import com.custom.core.xutils.db.annotation.Unique;
import com.custom.core.xutils.db.converter.ColumnConverter;
import com.custom.core.xutils.db.converter.ColumnConverterFactory;
import com.custom.core.xutils.db.sqlite.FinderLazyLoader;
import com.custom.core.xutils.db.sqlite.ForeignLazyLoader;
...
//        return field.getAnnotation(Finder.class) != null;
    ...
    public static Class<?> getForeignEntityType(com.custom.core.xutils.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(com.custom.core.xutils.db.table.Finder finderColumn) {
