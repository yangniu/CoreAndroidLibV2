...
public class UpFreshListView extends ListView implements OnScrollListener {
	...
	private int topArrowImage=R.drawable.view_arrow_black;
	...
	private void init(Context context) {
		...
		headView = (ViewGroup) inflater.inflate(R.layout.view_header_refresh_layout, null);
		arrowImageView = (ImageView) headView.findViewById(R.id.expand_header_refresh_layout_arrowImageView);
		arrowImageView.setMinimumWidth(70);
		arrowImageView.setMinimumHeight(50);
		
		progressBar = (ProgressBar) headView.findViewById(R.id.expand_header_refresh_layout_progressBar);
		tipsTextview = (TextView) headView.findViewById(R.id.expand_header_refresh_layout_tipsTextView);
		lastUpdatedTextView = (TextView) headView.findViewById(R.id.expand_header_refresh_layout_lastUpdatedTextView);
	...
	private View bottomLoadMoreBtnView(Context mcontext){
		...
		View footView= LayoutInflater.from(mcontext).inflate(
				R.layout.view_footer_loadmore_layout, null);
		footer_btn =(Button)footView.findViewById(R.id.expand_footer_loadmore_btn);
		bottomProgressBar =(ProgressBar)footView.findViewById(R.id.expand_footer_loadmore_progressbar);
		return footView;
	}
	...
	private View bottomLoadMoreAutoView(Context mcontext){
		...
		View footView= LayoutInflater.from(mcontext).inflate(
				R.layout.view_footer_loadmore_layout2, null);
		footerLipView =(TextView)footView.findViewById(R.id.expand_footer_loadmore2_text);
			...
			footer_btn.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if(onScrollLoadMoreListener!=null)
						onScrollLoadMoreListener.onScrollLoadMore(v);
				}
			});
		}
	}
