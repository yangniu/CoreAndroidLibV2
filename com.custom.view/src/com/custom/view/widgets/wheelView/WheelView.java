...
package com.custom.view.widgets.wheelView;
...
public class WheelView extends View
{
    ...
    private void initResourcesIfNecessary()
    {
        ...
        {
            centerDrawable = getContext().getResources().getDrawable(R.drawable.view_wheel_val);
        }
        ...
        setBackgroundResource(R.drawable.view_wheel_bg);
    }
