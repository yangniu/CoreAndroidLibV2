...
import com.custom.view.widgets.pulltorefresh.internal.EmptyViewMethodAccessor;
import com.custom.view.widgets.pulltorefresh.internal.LoadingLayout;
...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
    ...
    public void addFooterView() {
        if (footerView == null) {
            footerView = View.inflate(getContext(), R.layout.view_footer_loadmore_layout2, null);
            textView = (TextView) footerView.findViewById(R.id.expand_footer_loadmore2_text);
            progressBar = (ProgressBar) footerView.findViewById(R.id.expand_footer_loadmore2_progressbar);
        }
    ...
    public void removeFooterView(){
    	 if (footerView != null) {
	        getRefreshableView().removeFooterView(footerView);
	        getRefreshableView().setFooterDividersEnabled(true);
    	 }
    }
