 ...
 *******************************************************************************/
package com.custom.view.widgets.pulltorefresh;

import java.text.SimpleDateFormat;
import java.util.Date;

import com.custom.view.widgets.pulltorefresh.internal.*;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public final void onRefreshComplete() {
        if (isRefreshing()) {
            ...
            setLastUpdatedLabel(getResources().getString(R.string.pull_to_refresh_last_time_label)
            		+ getDateFarmat().format(new Date()));
        }
    }
    ...
    /**
     * @return Either {@link com.custom.view.widgets.pulltorefresh.PullToRefreshBase.Orientation#VERTICAL} or
     * {@link com.custom.view.widgets.pulltorefresh.PullToRefreshBase.Orientation#HORIZONTAL} depending on the scroll direction.
     */
     ...
     * {@link com.custom.view.widgets.pulltorefresh.PullToRefreshBase.State#PULL_TO_REFRESH} state.
     */
    ...
    /**
     * Called when the UI has been to be updated to be in the
     * {@link com.custom.view.widgets.pulltorefresh.PullToRefreshBase.State#REFRESHING} or {@link com.custom.view.widgets.pulltorefresh.PullToRefreshBase.State#MANUAL_REFRESHING} state.
     *
    ...
    /**
     * Called when the UI has been to be updated to be in the
     * {@link com.custom.view.widgets.pulltorefresh.PullToRefreshBase.State#RELEASE_TO_REFRESH} state.
     */
    ...
    /**
     * Called when the UI has been to be updated to be in the
     * {@link com.custom.view.widgets.pulltorefresh.PullToRefreshBase.State#RESET} state.
     */
    ...
    public static enum Mode {
         ...
         * {@link cn.com.sina.view.widgets.pulltorefresh.PullToRefreshBase#setRefreshing() setRefreshing()}.
         */
    ...
    public static interface OnPullEventListener<V extends View> {
         ...
         * @param direction   - One of {@link com.custom.view.widgets.pulltorefresh.PullToRefreshBase.Mode#PULL_FROM_START} or
         *                    {@link com.custom.view.widgets.pulltorefresh.PullToRefreshBase.Mode#PULL_FROM_END} depending on which direction
         *                    the user is pulling. Only useful when <var>state</var> is
         *                    {@link com.custom.view.widgets.pulltorefresh.PullToRefreshBase.State#PULL_TO_REFRESH} or
         *                    {@link com.custom.view.widgets.pulltorefresh.PullToRefreshBase.State#RELEASE_TO_REFRESH}.
         */
