...
public class LinkView extends TextView {
	...
	private LinkViewUrlOnClickListener linkViewUrlOnClickListener;
	...
	/**
	 * @param linkViewUrlOnClickListener the linkViewUrlOnClickListener to set
	 */
	public void setLinkViewUrlOnClickListener(
			LinkViewUrlOnClickListener linkViewUrlOnClickListener) {
		this.linkViewUrlOnClickListener = linkViewUrlOnClickListener;
	}
	...
	private class MyURLSpan extends ClickableSpan{     
		...
		public void onClick(View widget) {  
			...
			if(linkViewUrlOnClickListener!=null){
				linkViewUrlOnClickListener.onUrlClick(widget, mUrl);
			}
		}
	} 

	
	public interface LinkViewUrlOnClickListener{
		
		public void onUrlClick(View widget,String url);
	}
}
