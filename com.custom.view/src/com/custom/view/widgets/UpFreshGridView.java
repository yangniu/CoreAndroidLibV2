...
public class UpFreshGridView extends RelativeLayout implements OnScrollListener {
	...
	private OnScrollLoadMoreListener loadMoreListener = null;
	...
	private ViewGroup HeadUpdateView(Context mcontext) {
		...
		head_layout = (ViewGroup) LayoutInflater.from(mcontext).inflate(
				R.layout.view_header_refresh_layout, null);
		...
		topProgressBar = (ProgressBar) head_layout
				.findViewById(R.id.expand_header_refresh_layout_progressBar);
		tipsTextview = (TextView) head_layout
				.findViewById(R.id.expand_header_refresh_layout_tipsTextView);
		lastUpdatedTextView = (TextView) head_layout
				.findViewById(R.id.expand_header_refresh_layout_lastUpdatedTextView);
		return head_layout;
	}
	...
	private View bottomLoadMoreView(Context mcontext) {
		...
		bottomProgressBar = (ProgressBar) footView
				.findViewById(R.id.expand_footer_loadmore_progressbar);
		return footView;
	}
		...
		if (!hasAddFooter) {
			...
			footer_btn.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					loadMoreListener.onScrollLoadMore(v);
				}
			});
		}
	 ...
	 * @param listener
	 */
	public void setLoadMoreClickListener(OnScrollLoadMoreListener listener) {
