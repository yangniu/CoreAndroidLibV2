...
public class BaseDialog extends AbsBaseDialog {
	...
	protected void setContentLayoutView(LinearLayout contentLayout) {
		// TODO Auto-generated method stub
		View txtView =LayoutInflater.from(getContext()).inflate(R.layout.view_dialog_txt_part,null);
		txtContentView=(TextView) txtView.findViewById(R.id.expand_dialog_txt_view);
