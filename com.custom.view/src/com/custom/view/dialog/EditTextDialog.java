...
public class EditTextDialog extends AbsBaseDialog {
	...
	protected void setContentLayoutView(LinearLayout contentLayout) {
		// TODO Auto-generated method stub
		View txtView =LayoutInflater.from(getContext()).inflate(R.layout.view_dialog_edittext_part,null);
		contentEditTxt=(EditText) txtView.findViewById(R.id.expand_dialog_edittext_view);
