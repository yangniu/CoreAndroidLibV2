...
public class PicReferDialog extends AbsBaseDialog {
	...
	protected void setContentLayoutView(LinearLayout contentLayout) {
		// TODO Auto-generated method stub
		View picView =LayoutInflater.from(getContext()).inflate(R.layout.view_dialog_picrefer_part,null);
		contextTxt=(TextView) picView.findViewById(R.id.expand_dialog_picrefer_txt_content);
		iv_pic=(ImageView)picView.findViewById(R.id.expand_dialog_picrefer_pic_image);
