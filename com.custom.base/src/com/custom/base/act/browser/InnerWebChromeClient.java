...
import com.custom.view.dialog.EditTextDialog;
import com.custom.view.dialog.ProgressDialog;
import com.custom.view.dialog.AbsBaseDialog.OnDialogBtnClickListener;
...
public class InnerWebChromeClient extends WebChromeClient {
	...
	public boolean onJsAlert(WebView view, String url, String message,
		...
		baseDialog.setUpBtnClickListener(new OnDialogBtnClickListener() {
			@Override
	...
	public boolean onJsConfirm(WebView view, String url, String message,
		...
		baseDialog.setLeftBtnClickListener(new OnDialogBtnClickListener() {
		...
		baseDialog.setRightBtnClickListener(new OnDialogBtnClickListener() {
